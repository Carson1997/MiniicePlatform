var vm = new Vue({
	...
	methods: {
		...
		initSelect() {
			...
			this.selectRadio('#xm-select2', _this.xm_arr2)
			this.selectRadio('#xm-select3', _this.xm_arr3)
		...
		tableSourceDetail() {
			...
			var tData = changeFuZi('category2_source', _this.flow_data,3)
			...
			function dlEx(data) {
				...
				var ex_data = [];
				var ex_total = ['合计'];
				var total = getTotal(_this.flow_data, {},3)

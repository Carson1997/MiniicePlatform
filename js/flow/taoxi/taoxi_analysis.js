...
function goodsAnalysis() {
	...
	_this.send3.prd_id = '590716085952';
	_this.sel_goods = ['590716085952'];
...
function fillEachart3(ci) {
	...
	goodsData = _this.filterThis(_this.xm_sa1, goodsData, 'traffic_source');
...
function fillTable3() {
	...
	function dlEx(data) {
		...
		var ex_data = [];
		var ex_total = ['合计'];
		var total = getTotal(_this.goods_data3, {})
	...
	function dlEx2(data) {
		...
		var ex_data = [];
		var ex_total = getDateTotal(_this.goods_total, _this.xm_sd);

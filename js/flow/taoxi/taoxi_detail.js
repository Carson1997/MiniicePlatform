...
function filterData2(ci) {
	...
	_this.goods_data = _this.filterThis(_this.sel_s1, _this.goods_data, 'traffic_source');
	...
	_this.goods_arr2 = changeFuZi('traffic_source', goods_arr);
